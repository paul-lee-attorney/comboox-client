...
import { AddrOfRegCenter, AddrOfTank, HexType } from '../../../../read';
import { Close, OilBarrelOutlined } from '@mui/icons-material';
import { useState } from 'react';
import { getReceipt } from '../../../../read/toolsKit';
import { FormResults, bigIntToStrNum, defFormResults, hasError, onlyNum, strNumToBigInt } from '../../../../read/toolsKit';
import { ActionOfFuleProps } from '../ActionsOfFule';
import { LoadingButton } from '@mui/lab';
import { useComBooxContext } from '../../../../_providers/ComBooxContextProvider';
import { Receipt } from '../../../users/write/ActionsOfUser/TransferPoints';

export function FillTank({ refresh }: ActionOfFuleProps) {
