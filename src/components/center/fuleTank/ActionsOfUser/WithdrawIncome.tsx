...
import { AddrOfTank, HexType } from '../../../../scripts/common';
import { SavingsOutlined } from '@mui/icons-material';
import { useState } from 'react';
import { FormResults, defFormResults, hasError, onlyNum, refreshAfterTx, strNumToBigInt } from '../../../../scripts/common/toolsKit';
import { LoadingButton } from '@mui/lab';
import { useComBooxContext } from '../../../../scripts/common/ComBooxContext';
import { ActionOfUserProps } from '../ActionsOfUser';

export function WithdrawIncome({ refresh }: ActionOfUserProps) {
