      ...
      <Box sx={{ mt:2, width:1180 }}>
        <Paper elevation={3} sx={{m:1, p:1, border:1, borderColor:'divider'}}>
          ...
          <Typography variant="h6" component="div" sx={{ flexGrow: 1, m:2 }} color='text.secondary'>
            ...
            <p>By booking equity shares on-chain, investors may use <b>crypto currencies</b> to pay equitys consideration, which means effectively connecting the company’s equity shares to the trillion-dollar crypto markets, so that the companies may have an opportunity to have their equity value reevaluated and reconfirmed with the robust support of the huge liquidity.</p>
          </Typography>
