import { readContract, writeContract, getWalletClient, getContract, waitForTransaction, fetchBalance } from "@wagmi/core";
import { AddrOfRegCenter, AddrZero, Bytes32Zero, HexType, SelectorZero } from "../common";
import { payrollOfProjectABI, regCenterABI } from "../../generated";
